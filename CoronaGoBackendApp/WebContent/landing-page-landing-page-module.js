...
/***/ "./src/app/custom/landing-page/landing-page-detail/landing-page-detail.handler.ts":
/*!****************************************************************************************!*\
  !*** ./src/app/custom/landing-page/landing-page-detail/landing-page-detail.handler.ts ***!
  \****************************************************************************************/
/*! exports provided: LandingPageDetailHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LandingPageDetailHandler", function() { return LandingPageDetailHandler; });
var LandingPageDetailHandler = /** @class */ (function () {
    function LandingPageDetailHandler() {
    }
    LandingPageDetailHandler.prototype.updateActionBarConfig = function (actionConfig, type) {
        var actionBarconf = {
    ...
    LandingPageDetailHandler.prototype.updateCaptionConfig = function (captionConfig, type) {
        return captionConfig;
    };
    LandingPageDetailHandler.prototype.customCaptionbarAction = function (data) { };
    LandingPageDetailHandler.prototype.customCaptionbarInitComplete = function (data) {
        this.customCaption = data;
    };
    LandingPageDetailHandler.prototype.customActionbarInitComplete = function (data) {
        this.actionbarMap = data;
    };
    LandingPageDetailHandler.prototype.customWorkflowActionbarInitComplete = function (data) { };
    LandingPageDetailHandler.prototype.updateFormConfig = function (currentConfig, localPlaceHolder) {
        return currentConfig;
    };
    LandingPageDetailHandler.prototype.updateFormdata = function (data) {
        return data;
    };
    LandingPageDetailHandler.prototype.validateDataBeforeSave = function (data) {
        return data;
    };
    LandingPageDetailHandler.prototype.customFormInitComplete = function (form) {
        this.customFormConfig = form;
    };
    LandingPageDetailHandler.prototype.customDataChanged = function (data) { };
    LandingPageDetailHandler.prototype.handleCustomEvents = function (e, form) { };
    LandingPageDetailHandler.prototype.onAfterServiceResponse = function (data) { };
    LandingPageDetailHandler.prototype.onAfterResponseData = function (data) { };
    LandingPageDetailHandler.prototype.customActionHandler = function (btn) {
        return false;
    };
    LandingPageDetailHandler.prototype.customConfirmConfig = function (confirmConfig, btn) {
        return confirmConfig;
    };
    return LandingPageDetailHandler;
}());
...
/***/ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.html":
/*!*************************************************************************************!*\
  !*** ./src/app/landing-page/landing-page-detail/landing-page-detail.component.html ***!
  \*************************************************************************************/
...
/***/ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.scss":
/*!*************************************************************************************!*\
  !*** ./src/app/landing-page/landing-page-detail/landing-page-detail.component.scss ***!
  \*************************************************************************************/
/*! no static exports found */
...
module.exports = ".page-header-part {\n  background-color: #6e69ea;\n  border-radius: 0px;\n  margin: 0px; }\n  .page-header-part .detail-page-header-label {\n    text-transform: unset;\n    color: #fff; }\n  .page-header-part .detail-page-actionbar {\n    display: none; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.ts":
/*!***********************************************************************************!*\
  !*** ./src/app/landing-page/landing-page-detail/landing-page-detail.component.ts ***!
  \***********************************************************************************/
/*! exports provided: LandingPageDetailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LandingPageDetailComponent", function() { return LandingPageDetailComponent; });
...
/* harmony import */ var _app_security_landing_page_landing_page_detail_landing_page_detail_security__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @app/security/landing-page/landing-page-detail/landing-page-detail.security */ "./src/app/security/landing-page/landing-page-detail/landing-page-detail.security.js");
/* harmony import */ var _app_custom_landing_page_landing_page_detail_landing_page_detail_handler__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @app/custom/landing-page/landing-page-detail/landing-page-detail.handler */ "./src/app/custom/landing-page/landing-page-detail/landing-page-detail.handler.ts");
/* harmony import */ var _landing_page_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../landing-page.service */ "./src/app/landing-page/landing-page.service.ts");
...
var LandingPageDetailComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](LandingPageDetailComponent, _super);
    function LandingPageDetailComponent(location, http, route, router, uploadService, utilService, baseService, appGlobalService, landingPageService, modalPopupService) {
        ...
        _this.landingPageService = landingPageService;
     ...
     */
    LandingPageDetailComponent.prototype.actionBarConfiguration = function () {
        var actionBarconf = {
            showMobilePrimary: true,
            buttons: {
                primary: [
     ...
     */
    LandingPageDetailComponent.prototype.workflowActionBarConfiguration = function () {
     ...
     */
    LandingPageDetailComponent.prototype.captionbarConfiguration = function () {
        var captionbarconf = {
            modules: [],
    ...
    LandingPageDetailComponent.prototype.goBack = function () {
        var _this = this;
    ...
    LandingPageDetailComponent.prototype.navigateToDetail = function (id, page) {
        var pathParams = {
            id: id ? id : ''
        };
    ...
    LandingPageDetailComponent.prototype.getFormConfig = function (securityJson) {
    ...
    LandingPageDetailComponent.prototype.LandingPageDetailFormInitComplete = function (form) {
        this.customFormInitComplete(form);
    };
    LandingPageDetailComponent.prototype.displayBooleanData = function (data, type, row) {
        return (data === true ? '<div class="text-center app-users-tick"><i class="fa fa-check"></i></div>' : '');
    };
    LandingPageDetailComponent.prototype.normalizeData = function (data) {
        data = this.updateFormdata(data);
        return data;
    };
    LandingPageDetailComponent.prototype.updateCaptionBarWithData = function (data) {
    ...
    LandingPageDetailComponent.prototype.responseDataManipulation = function (data, dontPatch) {
        if (!data) {
    ...
    LandingPageDetailComponent.prototype.getData = function () {
        var _this = this;
        if (!this.id) {
            return;
        }
        ...
        this.landingPageService.getLandingPageBySid(params).subscribe(function (response) {
            _this.child.form.patchValue(response);
            _this.responseDataManipulation(response, true);
        });
    };
    LandingPageDetailComponent.prototype.saveAddedFiles = function (splittedData) {
        var _this = this;
    ...
    LandingPageDetailComponent.prototype.saveDataThenFiles = function (method, splittedData, saveFiles) {
        var _this = this;
        var service;
        if (method === 'post') {
    ...
    LandingPageDetailComponent.prototype.saveData = function () {
    ...
    LandingPageDetailComponent.prototype.resetData = function () {
        var _this = this;
    ...
    LandingPageDetailComponent.prototype.getSecurityJSON = function () {
        var currentUser = this.getCurrentUser();
        var securityJson = _app_security_landing_page_landing_page_detail_landing_page_detail_security__WEBPACK_IMPORTED_MODULE_13__["default"];
        var roles = [];
    ...
    LandingPageDetailComponent.prototype.getCurrentUser = function () {
        return this.appGlobalService.get('currentUser');
    };
    LandingPageDetailComponent.prototype.onCreateAction = function (btn) {
        var _this = this;
        var co = {
            header: 'Confirm?',
        ...
        confirm.subscribe(function (isConfirmed) {
            if (isConfirmed) {
                var createSubscriber = _this.landingPageService.createLandingPage(_this.id);
    ...
    LandingPageDetailComponent.prototype.onUpdateAction = function (btn) {
        var _this = this;
        var co = {
            header: 'Confirm?',
        ...
        confirm.subscribe(function (isConfirmed) {
            if (isConfirmed) {
                var updateSubscriber = _this.landingPageService.updateLandingPage(_this.id);
    ...
    LandingPageDetailComponent.prototype.onDeleteAction = function (btn) {
        var _this = this;
        var co = {
            header: 'Confirm?',
        ...
        confirm.subscribe(function (isConfirmed) {
            if (isConfirmed) {
                var deleteSubscriber = _this.landingPageService.deleteLandingPage(_this.id);
    ...
    LandingPageDetailComponent.prototype.setFileFields = function () {
    ...
    LandingPageDetailComponent.prototype.ngOnInit = function () {
    ...
    ], LandingPageDetailComponent.prototype, "child", void 0);
    LandingPageDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-landing-page-detail',
            template: __webpack_require__(/*! ./landing-page-detail.component.html */ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.html"),
            styles: [__webpack_require__(/*! ./landing-page-detail.component.scss */ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common__WEBPACK_IMPORTED_MODULE_3__["Location"],
            ...
            _landing_page_service__WEBPACK_IMPORTED_MODULE_15__["LandingPageService"],
            _app_shared_services_modal_popup_service__WEBPACK_IMPORTED_MODULE_16__["ModalPopupService"]])
    ], LandingPageDetailComponent);
    return LandingPageDetailComponent;
}(_app_custom_landing_page_landing_page_detail_landing_page_detail_handler__WEBPACK_IMPORTED_MODULE_14__["LandingPageDetailHandler"]));
...
/* harmony import */ var _landing_page_detail_landing_page_detail_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./landing-page-detail/landing-page-detail.component */ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.ts");
...
var routes = [
    ...
    },
    {
        ...
        component: _landing_page_detail_landing_page_detail_component__WEBPACK_IMPORTED_MODULE_4__["LandingPageDetailComponent"],
...
/* harmony import */ var _landing_page_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./landing-page-routing.module */ "./src/app/landing-page/landing-page-routing.module.ts");
/* harmony import */ var _landing_page_detail_landing_page_detail_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./landing-page-detail/landing-page-detail.component */ "./src/app/landing-page/landing-page-detail/landing-page-detail.component.ts");
...
var LandingPageModule = /** @class */ (function () {
    ...
    LandingPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _landing_page_detail_landing_page_detail_component__WEBPACK_IMPORTED_MODULE_7__["LandingPageDetailComponent"]
            ],
            imports: [
                ...
                _landing_page_routing_module__WEBPACK_IMPORTED_MODULE_6__["LandingPageRoutingModule"]
            ],
            entryComponents: [],
            exports: []
        })
...
var LandingPageService = /** @class */ (function () {
    function LandingPageService(baseService) {
        this.baseService = baseService;
    }
    LandingPageService.prototype.getRandomData = function (items) {
        return items[Math.floor(Math.random() * items.length)];
    };
    LandingPageService.prototype.getRandomIndex = function (arr) {
        return Math.round(Math.random() * (arr.length - 1));
    };
    // CRUD operations starts
    LandingPageService.prototype.getPrototypingData = function (columns) {
        var e_1, _a;
        var gridData = [];
        var dummyData = {
    ...
    LandingPageService.prototype.deleteLandingPage = function (params) {
        var _this = this;
        var serviceOpts = _app_api_constants__WEBPACK_IMPORTED_MODULE_4__["ApiConstants"].deleteLandingPage;
    ...
    LandingPageService.prototype.createLandingPage = function (params) {
        var _this = this;
        var serviceOpts = _app_api_constants__WEBPACK_IMPORTED_MODULE_4__["ApiConstants"].createLandingPage;
        var subject = new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            _this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe(function (response) {
                observer.next(response);
            }, function (err) {
    ...
    LandingPageService.prototype.updateLandingPage = function (params) {
        var _this = this;
        var serviceOpts = _app_api_constants__WEBPACK_IMPORTED_MODULE_4__["ApiConstants"].updateLandingPage;
        var subject = new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            _this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe(function (response) {
                observer.next(response);
            }, function (err) {
    ...
    LandingPageService.prototype.getLandingPageBySid = function (params) {
        var _this = this;
        var serviceOpts = _app_api_constants__WEBPACK_IMPORTED_MODULE_4__["ApiConstants"].getLandingPageBySid;
        var subject = new rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"](function (observer) {
            _this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe(function (response) {
                observer.next(response);
            }, function (err) {
    ...
    LandingPageService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/security/landing-page/landing-page-detail/landing-page-detail.security.js":
/*!*******************************************************************************************!*\
  !*** ./src/app/security/landing-page/landing-page-detail/landing-page-detail.security.js ***!
  \*******************************************************************************************/
