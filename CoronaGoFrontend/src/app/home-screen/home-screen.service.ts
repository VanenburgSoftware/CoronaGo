...
export class HomeScreenService {
  ...
  public createHomeScreen(params: any): any {
    const serviceOpts=ApiConstants.createHomeScreen;
  ...
  public getHomeScreenBySid(params: any): any {
    const serviceOpts=ApiConstants.getHomeScreenBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public updateHomeScreen(params: any): any {
    const serviceOpts=ApiConstants.updateHomeScreen;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteHomeScreen(params: any): any {
    const serviceOpts=ApiConstants.deleteHomeScreen;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
