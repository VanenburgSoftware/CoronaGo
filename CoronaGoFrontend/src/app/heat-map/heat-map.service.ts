...
export class HeatMapService {
  ...
  public updateHeatMap(params: any): any {
    const serviceOpts=ApiConstants.updateHeatMap;
  ...
  public createHeatMap(params: any): any {
    const serviceOpts=ApiConstants.createHeatMap;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteHeatMap(params: any): any {
    const serviceOpts=ApiConstants.deleteHeatMap;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getHeatMapBySid(params: any): any {
    const serviceOpts=ApiConstants.getHeatMapBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
