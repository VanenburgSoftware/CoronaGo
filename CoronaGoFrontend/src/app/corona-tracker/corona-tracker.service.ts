...
export class CoronaTrackerService {
  ...
  public updateCoronaTracker(params: any): any {
    const serviceOpts=ApiConstants.updateCoronaTracker;
  ...
  public deleteCoronaTracker(params: any): any {
    const serviceOpts=ApiConstants.deleteCoronaTracker;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public createCoronaTracker(params: any): any {
    const serviceOpts=ApiConstants.createCoronaTracker;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getCoronaTrackerBySid(params: any): any {
    const serviceOpts=ApiConstants.getCoronaTrackerBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
