...
export class LandingPageService {
  ...
  public deleteLandingPage(params: any): any {
    const serviceOpts=ApiConstants.deleteLandingPage;
  ...
  public createLandingPage(params: any): any {
    const serviceOpts=ApiConstants.createLandingPage;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public updateLandingPage(params: any): any {
    const serviceOpts=ApiConstants.updateLandingPage;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getLandingPageBySid(params: any): any {
    const serviceOpts=ApiConstants.getLandingPageBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
