...
export class StockInHospitalService {
  ...
  public createStockInHospital(params: any): any {
    const serviceOpts = ApiConstants.createStockInHospital;
  ...
  public updateStockInHospital(params: any): any {
    const serviceOpts = ApiConstants.updateStockInHospital;
    const subject = new Observable(observer => {
      this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getStockInHospitalBySid(params: any): any {
    const serviceOpts = ApiConstants.getStockInHospitalBySid;
    const subject = new Observable(observer => {
      this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteStockInHospital(params: any): any {
    const serviceOpts = ApiConstants.deleteStockInHospital;
    const subject = new Observable(observer => {
      this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getStockInHospitalAll_StockInHospital(params: any): any {
    const serviceOpts = ApiConstants.getStockInHospitalAll_StockInHospital;
    const subject = new Observable(observer => {
      this.baseService[serviceOpts.method.toLowerCase()](serviceOpts, params).subscribe((response) => {
        observer.next(response);
      },
