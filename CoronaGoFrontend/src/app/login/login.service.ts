...
export class LoginService {
  ...
  public updateLogin(params: any): any {
    const serviceOpts=ApiConstants.updateLogin;
  ...
  public deleteLogin(params: any): any {
    const serviceOpts=ApiConstants.deleteLogin;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public createLogin(params: any): any {
    const serviceOpts=ApiConstants.createLogin;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getLoginBySid(params: any): any {
    const serviceOpts=ApiConstants.getLoginBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
