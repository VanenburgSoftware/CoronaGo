...
import { NotYetAssignedListMobileViewComponent } from './not-yet-assigned-list-mobile-view/not-yet-assigned-list-mobile-view.component';

import { PatientQuestionaireService } from '../patient-questionaire.service';
import { utils } from 'protractor';
@Component({
  selector: 'app-not-yet-assigned',
  templateUrl: './not-yet-assigned.component.html',
  styleUrls: [ './not-yet-assigned.component.scss' ]
})

export class NotYetAssignedComponent implements OnInit, AfterViewInit {
  public gridConfig: any = {};
  public actionBarconf: any = [];
  private refreshGrid: any;
  private dtTable: any;
  private subscriptions: any = [];
  public pageName = 'NOT_YET_ASSIGNED_LIST';
  ...
  private loadGridConfig(): any {
    ...
    const gridConfig: any = {
      ...
      mobileTemplate: NotYetAssignedListMobileViewComponent,
    ...
    if (this.isPrototyping) {
      ...
      gridConfig.ajaxUrl = '/' + AppConstants.apihost + '/' + ApiConstants.getPatientQuestionaireAll_NotYetAssigned.url;
    }
