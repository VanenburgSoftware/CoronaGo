...
import { PatientQuestionaireListHandler } from '@custom/patient-questionaire/patient-questionaire-list/patient-questionaire-list.handler';
import { PatientQuestionaireService } from '../patient-questionaire.service';
import { PatientQuestionaireListMobileViewComponent } from './patient-questionaire-list-mobile-view/patient-questionaire-list-mobile-view.component';

@Component({
  selector: 'app-patient-questionaire-list',
  templateUrl: './patient-questionaire-list.component.html',
  styleUrls: ['./patient-questionaire-list.component.scss']
})
export class PatientQuestionaireListComponent extends PatientQuestionaireListHandler implements OnInit, AfterViewInit {
  ...
  public pageName = 'PATIENT_QUESTIONAIRE_LIST';
  ...
  private loadGridConfig(): any {
    ...
    const gridConfig: any = {
      ...
      mobileTemplate: PatientQuestionaireListMobileViewComponent,
    ...
    if (this.isPrototyping) {
      ...
      gridConfig.ajaxUrl = '/' + AppConstants.apihost + '/' + ApiConstants.getPatientQuestionaireAll_PatientQuestionaire.url;
    }
  ...
  loadKanbanOptions() {
    const config = {
      url: this.isPrototyping ? '' : '/' + AppConstants.apihost + '/' + ApiConstants.getPatientQuestionaireAll_PatientQuestionaire.url,
      template: '',
      lanes: [],
      groupBy: '',
      laneBy: '',
