...
export class AppUserPrivilegesService {
  ...
  public updateAppUserPrivileges(params: any): any {
    const serviceOpts=ApiConstants.updateAppUserPrivileges;
  ...
  public getCurrentUser(params: any): any {
    const serviceOpts=ApiConstants.getCurrentUser;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getAppUserPrivilegesBySid(params: any): any {
    const serviceOpts=ApiConstants.getAppUserPrivilegesBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getAppUserPrivilegesByEmail(params: any): any {
    const serviceOpts=ApiConstants.getAppUserPrivilegesByEmail;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getAppUserPrivilegesAll_AppUserPrivileges(params: any): any {
    const serviceOpts=ApiConstants.getAppUserPrivilegesAll_AppUserPrivileges;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteAppUserPrivileges(params: any): any {
    const serviceOpts=ApiConstants.deleteAppUserPrivileges;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public createAppUserPrivileges(params: any): any {
    const serviceOpts=ApiConstants.createAppUserPrivileges;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
