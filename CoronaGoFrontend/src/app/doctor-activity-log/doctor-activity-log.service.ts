...
export class DoctorActivityLogService {
  ...
  public createDoctorActivityLog(params: any): any {
    const serviceOpts=ApiConstants.createDoctorActivityLog;
  ...
  public getDoctorActivityLogAll_DoctorActivityLog(params: any): any {
    const serviceOpts=ApiConstants.getDoctorActivityLogAll_DoctorActivityLog;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public updateDoctorActivityLog(params: any): any {
    const serviceOpts=ApiConstants.updateDoctorActivityLog;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteDoctorActivityLog(params: any): any {
    const serviceOpts=ApiConstants.deleteDoctorActivityLog;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getDoctorActivityLogBySid(params: any): any {
    const serviceOpts=ApiConstants.getDoctorActivityLogBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
