...
export class MeetingsService {
  ...
  public updateMeetings(params: any): any {
    const serviceOpts=ApiConstants.updateMeetings;
  ...
  public createMeetings(params: any): any {
    const serviceOpts=ApiConstants.createMeetings;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getMeetingsBySid(params: any): any {
    const serviceOpts=ApiConstants.getMeetingsBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public deleteMeetings(params: any): any {
    const serviceOpts=ApiConstants.deleteMeetings;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getMeetingsAll_Meetings(params: any): any {
    const serviceOpts=ApiConstants.getMeetingsAll_Meetings;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
