...
export class ResourcesService {
  ...
  public createResources(params: any): any {
    const serviceOpts=ApiConstants.createResources;
  ...
  public deleteResources(params: any): any {
    const serviceOpts=ApiConstants.deleteResources;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public getResourcesBySid(params: any): any {
    const serviceOpts=ApiConstants.getResourcesBySid;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
  ...
  public updateResources(params: any): any {
    const serviceOpts=ApiConstants.updateResources;
    const subject = new Observable(observer => {
      this.baseService[ serviceOpts.method.toLowerCase() ](serviceOpts,params).subscribe((response) => {
        observer.next(response);
      },
