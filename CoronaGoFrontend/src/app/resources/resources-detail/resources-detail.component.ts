...
import SecurityJson from '@app/security/resources/resources-detail/resources-detail.security';
import { ResourcesDetailHandler } from '@app/custom/resources/resources-detail/resources-detail.handler';
...
export class ResourcesDetailComponent extends ResourcesDetailHandler implements OnInit {
  ...
  public ResourcesDetailFormInitComplete(form: any) {
  ...
  private getData() {
    ...
    this.resourcesService.getResourcesBySid(params).subscribe((response: any) => {
  ...
  private onCreateAction(btn: any): void {
    ...
    confirm.subscribe((isConfirmed: boolean) => {
      if (isConfirmed) {
        const createSubscriber = this.resourcesService.createResources(this.id);
  ...
  private onUpdateAction(btn: any): void {
    ...
    confirm.subscribe((isConfirmed: boolean) => {
      if (isConfirmed) {
        const updateSubscriber = this.resourcesService.updateResources(this.id);
  ...
  private onDeleteAction(btn: any): void {
    ...
    confirm.subscribe((isConfirmed: boolean) => {
      if (isConfirmed) {
        const deleteSubscriber = this.resourcesService.deleteResources(this.id);
