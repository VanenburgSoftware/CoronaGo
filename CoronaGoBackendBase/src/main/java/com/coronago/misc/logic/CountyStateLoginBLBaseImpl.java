...
public class CountyStateLoginBLBaseImpl<T extends CountyStateLoginBase> extends BaseBusinessLogic<T>
		implements ICountyStateLoginBLBase<T> {
	public CountyStateLoginBLBaseImpl(Class<T> modelClass) {
		super(modelClass);
	}
