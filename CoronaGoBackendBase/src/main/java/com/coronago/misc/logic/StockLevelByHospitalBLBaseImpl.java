...
public class StockLevelByHospitalBLBaseImpl<T extends StockLevelByHospitalBase> extends BaseBusinessLogic<T>
		implements IStockLevelByHospitalBLBase<T> {
	public StockLevelByHospitalBLBaseImpl(Class<T> modelClass) {
		super(modelClass);
	}
